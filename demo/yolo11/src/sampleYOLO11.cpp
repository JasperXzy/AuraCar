...
{
public:
    SampleYOLO11(const char *modelPath, const int32_t modelWidth, const int32_t modelHeight);
    Result InitResource();
...
SampleYOLO11::SampleYOLO11(const char *modelPath, const int32_t modelWidth, const int32_t modelHeight) : modelPath_(modelPath), modelWidth_(modelWidth), modelHeight_(modelHeight)
{
}

SampleYOLO11::~SampleYOLO11()
{
    ReleaseResource();
}

Result SampleYOLO11::InitResource()
{
    // init acl resource
...
Result SampleYOLO11::ProcessInput(string testImgPath)
{
...
Result SampleYOLO11::Inference(std::vector<InferenceOutput> &inferOutputs)
{
...
Result SampleYOLO11::GetResult(std::vector<InferenceOutput> &inferOutputs,
                               string imagePath, size_t imageIndex, bool release)
{
    ...
    // total number of boxs yolo11 [1,84,8400]
...
void SampleYOLO11::ReleaseResource()
{
...
int main()
{
    ...
    string fileName;
    bool release = false;
    SampleYOLO11 sampleYOLO(modelPath, modelWidth, modelHeight);
